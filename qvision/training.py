...
def train(optimizer_name, weights, bias, trainImgs, trainLabels, testImgs, testLabels, num_epochs, lr_weights, lr_bias, num_shots, phase_shift):
    ...
    weights, bias, loss_history, test_loss_history, accuracy_history, test_accuracy_history = optimizer(optimizer_name,
        ...
        num_epochs, lr_weights, lr_bias, num_shots, phase_shift
    )
